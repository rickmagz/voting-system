                                    ...
                                    <div class="card-body" style="background: var(--bs-card-bg);border-radius: 10px;">
                                        <div class="row" style="background: var(--bs-card-bg);padding-bottom: 0px;padding-top: 10px;border-radius: 10px;">
                                            <div class="col-5 col-sm-4 col-md-3 col-lg-2 col-xl-2 offset-0" style="height: 98.975px;margin-bottom: 6px;">
                                                <figure class="figure"><img class="rounded-circle img-fluid figure-img" src="uploads/<?php echo $image; ?>" width="300px" height="300px"></figure>
                                            </div>
                                            <div class="col-12 col-sm-6 col-md-7 col-lg-10 col-xl-8" style="margin-top: 11px;">
                                                <h3 style="font-weight: bold;font-family: Muli;color: var(--bs-black);"><?php echo $first_name; ?> <?php echo $last_name; ?> (<?php echo $if_cand; ?>)</h3><span style="font-size: 21px;">Student ID: <?php echo $id; ?><br></span><a class="btn btn-primary" type="button" style="font-family: Muli;font-size: 14px;border-width: 1px;margin-top: 10px;font-weight: bold;padding-right: 30px;padding-left: 30px;text-align: center;" href="editprofile.php?id=<?php echo $id; ?>" target="_self">edit profile</a>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 35px;background: #eff3f8;border-radius: 10px;margin-right: 10px;margin-left: 10px;padding: 7px;padding-top: 10px;padding-bottom: 10px;">
                                            <div class="col-xl-12" id="council">
                                                <h5 style="font-weight: bold;font-family: Muli;color: var(--bs-black);padding-bottom: 0px;">Council</h5><span style="font-size: 21px;"><?php echo $council; ?></span>
                                            </div>
                                            <div class="col-xl-12" id="course" style="padding-top: 10px;margin-top: 14px;">
                                                <h5 style="font-weight: bold;font-family: Muli;color: var(--bs-black);">Course</h5><span style="font-size: 21px;"><?php echo $course; ?></span>
                                            </div>
                                            <div class="col-xl-12" id="course" style="padding-top: 10px;margin-top: 14px;">
                                                <h5 style="font-weight: bold;font-family: Muli;color: var(--bs-black);">Major</h5><span style="font-size: 21px;"><?php echo $major; ?></span>
                                            </div>
                                            <div class="col-xl-12" id="yearsec" style="padding-top: 10px;margin-top: 14px;">
                                                <h5 style="font-weight: bold;font-family: Muli;color: var(--bs-black);">Year &amp; Section</h5><span style="font-size: 21px;"><?php echo $year; ?>-<?php echo $section; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
