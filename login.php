            ...
            <form action="register.php" method="POST">
                ...
                <div class="card" style="box-shadow: 0px 0px 20px var(--bs-gray);">
                    <div class="card-body" style="color: var(--bs-black);">
                        ...
                        <div class="row">
                            <div class="col-sm-10 col-md-8 col-lg-8 col-xl-6 offset-sm-1 offset-md-2 offset-lg-2 offset-xl-3" id="username"><div class="form-floating mb-3 mt-3">
  <input type="text" class="form-control" id="username" placeholder="Enter Username" name="username" required>
  <label for="email">Username</label>
</div></div>
                            <div class="col-sm-10 col-md-8 col-lg-8 col-xl-6 offset-sm-1 offset-md-2 offset-lg-2 offset-xl-3" id="password"><div class="form-floating mb-3 mt-3">
  <input type="password" class="form-control" id="password" placeholder="Enter password" name="password" required>
  <label for="email">Password</label>
</div></div>
                        </div>
                        <div class="row">
                            <div class="col-xl-6 offset-xl-3 text-center" id="username-1"><button class="btn btn-primary" type="submit">Log In</button><a class="btn btn-secondary" role="button" href="index.php">Back to home</a></div>
                        </div>
                    </div>
                </div>
            </form>
