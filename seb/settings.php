...
<html lang="en">
  ...
  >
    <nav
      class="navbar navbar-light navbar-expand-lg fixed-top shadow-none"
      style="
        padding-top: 0px;
        padding-bottom: 0px;
      ...
      <div class="container">
        <a class="navbar-brand d-flex align-items-center" href="#"
          ><img
            width="75"
            height="75"
            src="../assets/img/ISAT-U-logo-shadow1.png"
          /><img width="75" height="75" src="../assets/img/sr-logo.png" /><span
            style="
              margin-left: 4px;
        ...
        <div class="collapse navbar-collapse" id="navcol-2">
          <ul
            ...
            style="color: var(--bs-black); font-weight: bold"
          >
            <li class="nav-item">
              <a
                class="nav-link"
            ...
            <li class="nav-item dropstart">
              ...
              >
                <a
                  class="dropdown-item"
                  style="--bs-body-color: var(--bs-navbar-brand-color)"
                  href="election_mgt.html#tab-1"
                  >Election<br />Management</a
                ><a class="dropdown-item" href="seb.html">About S.E.B.</a
                ><a class="dropdown-item" href="results.html"
                  >Print Election<br />Results</a
                >
                ...
                <a class="dropdown-item" href="#" style="text-align: left"
                  ><img
                    width="30"
                    height="30"
                    src="../assets/img/Screenshot_2021-01-28-04-41-56-92.jpg"
                  />&nbsp;Admin</a
                ><a
                  class="dropdown-item"
                  href="settings.html"
    ...
    <main style="margin: 0 auto; margin-bottom: 491px">
      <div
        class="row"
        style="margin-top: 128px; margin-right: 24px; margin-left: 24px"
      >
        <div
          class="col-sm-12 col-md-8 col-lg-12 col-xl-10 offset-md-0 offset-lg-0 offset-xl-1 align-self-center"
        >
          ...
          <div>
            <ul class="nav nav-pills" role="tablist">
              <li
                ...
                role="presentation"
                style="border-width: 0px; border-bottom-left-radius: 0px"
              >
                <a
            ...
            >
              ...
              >
                <div class="card" style="border-radius: 10px">
                  <div
                    class="card-body"
                    style="background: var(--bs-card-bg); border-radius: 10px"
                  >
                    <div
                      class="row"
                      style="
                    ...
                    >
                      <div
                        class="col-5 col-sm-4 col-md-3 col-lg-2 col-xl-2 offset-0"
                        style="height: 98.975px; margin-bottom: 6px"
                      >
                        <figure class="figure">
                          <img
                            class="rounded-circle img-fluid figure-img"
                            src="../assets/img/Screenshot_2021-01-28-04-41-56-92.jpg"
                            width="300px"
                            height="300px"
                          />
                      ...
                      <div
                        class="col-12 col-sm-6 col-md-7 col-lg-10 col-xl-8"
                      ...
                      >
                        ...
                        <span style="font-size: 21px">2018-1233456-M<br /></span
                        ><button
                    ...
                    >
                      ...
                      <div
                        class="col-xl-12"
                        id="council"
                        style="padding-top: 10px; margin-top: 14px"
                      >
                        <h5
                          style="
                            font-weight: bold;
      ...
      >
        <div class="modal-content">
          <div class="modal-header">
            <h4
              class="modal-title"
              style="font-family: Muli; font-weight: bold"
            >
              Edit User Account
            </h4>
            <button
            ...
            >
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-xl-6">
                    <input
                      class="border rounded shadow-sm form-control"
                      type="file"
                      autofocus=""
                      required=""
                      style="width: 289.2px; height: 32px"
                    />
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-xl-9">
                    <select
                      class="border rounded shadow-sm form-select"
                      name="council"
