            ...
            ">
                <div class="card-body">
                    <h2 style="font-family: Muli">
                        <strong>Edit S.E.B. Information</strong>
                    </h2>
                    <div class="row">
                    ...
                    <div class="row  mt-3 mb-3">
                        <div class="col-xl-4" id="username">
                            ...
                            <input type="text" class="form-control" id="username" value="<?php echo $i['username']; ?>" name="username" required />
                        </div>
                        <div class="col-xl-4" id="password">
                            <label for="email">Password</label>
                            <input type="password" class="form-control" id="password" value="<?php echo $i['password']; ?>" name="password" required />
                        </div>
